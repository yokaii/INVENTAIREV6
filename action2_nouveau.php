...
VALUES ('$A',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','$CODEinv','$DETAILinv','$FIBREinv','$COULEURinv','$BACKinv',
...
<body>
	<div class="content">
		<div class="title-head"><h6><center><br><?php echo "L'insertion du nouveau produit " . $A;echo " a été effectué"; ?></center></h6></div>
